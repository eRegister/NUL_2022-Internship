...
sys.path.append('/home/seipobi/.local/bin/graph-onedrive')
...
def main() -> None:
    ...
    # bash_cmd = '/home/seipobi//Documents/ICAP/NUL_2022-Internship/Automate-HIE-Backups/backup.sh'
    # os.system(bash_cmd)

    # Find the latest backup file
    list_of_files = glob.glob('/home/seipobi/backup/*')  # * means all if need specific format then *.csv
